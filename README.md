# JAXRS_Example_Events
> Example RESTful API "Events" developed with JAX-RS (Jersey) on JakartaEE9 and Tomcat 10
 
This is the full implementation of the "Events" RESTful API developed during the course lectures. It shows how to model the service using JAX-RS, including sub-resources, bearer token authorization and CORS headers injection.
